		...
		<div class="panel panel-info" data-collapsed="0">
		    ...
		    <form role="form" name="miformulario" action="capturar.php" method="post" >
					...
					<div class="col-md-6 form-group">
						...
						<input type="text" name="txtno" class="form-control" required placeholder="ingrese su nombre" >
					</div>

					<div class="col-md-6 form-group">
							<label><strong>DPI(*)</strong></label>
						<input type="text"  name="txtdo" id="txtdo" minLength="13" maxlength="13" required class="form-control" placeholder="ingrese su numero">
					</div>
