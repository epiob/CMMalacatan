...
<table class="table table-bordered datatable" id="table-1">
		...
		foreach((array)$result as $row){
			...
			?>
					...
					<td>
						<?php echo "<a href='actualizar.php?idlab_pro=".$row['idlab_pro']."' class='btn btn-info btn-sm btn-icon icon-left'><i class='entypo-pencil'></i>Editar</a>"?>
						<?php echo "<a href='eliminar.php?cod=".$row['idlab_pro']."' class='btn btn-danger btn-sm btn-icon icon-left'><i class='entypo-cancel'></i>Eliminar</a>"?>
					</tr>
					</td>
