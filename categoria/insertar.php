			...
			<div class="panel-body">
				<form role="form" class="form-horizontal form-groups-bordered" action="capturar.php" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="txtfa" class="form-control" required placeholder="ingrese la Forma Farmaceutica">
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label" >F.F Simplificada(*)</label>
						<div class="col-sm-5">
							<input type="text" name="txtff" class="form-control" required placeholder="ingrese la F.F Simplificada">
						</div>
					</div>
					<div class="form-group">
